...
public class RecordJarResource {
    ...
    public Response uploadFormText(@ApiParam(value = "Encoding of the specified record-jar formatted file.", example="UTF-8", defaultValue = "UTF-8") @FormParam("encoding") String encoding,
                               @ApiParam(value = "Record Jar formatted text", required = true) @FormParam("record-jar-text") String recordJarText) {
        if (encoding == null) {
            encoding = "UTF-8";
        }
